...
const items = [
  ...
  { key: '/leads', label: <Link to="/leads">Leads</Link>, icon: <UserOutlined /> },
  { key: '/customers', label: <Link to="/customers">Customers</Link>, icon: <TeamOutlined /> },
  { key: '/properties', label: <Link to="/properties">Properties</Link>, icon: <ApartmentOutlined /> },
  { key: '/tasks', label: <Link to="/tasks">Tasks</Link>, icon: <UnorderedListOutlined /> },
];
      ...
      >
        <div className="px-5 py-6">
          <div className="rounded-xl border border-white/15 bg-white/10 px-4 py-3">
            <p className="m-0 text-xs uppercase tracking-[0.2em] text-cyan-200">Demo Edition</p>
            <p className="m-0 mt-1 text-lg font-semibold text-white">Real Estate CRM</p>
          </div>
        </div>
        <Menu
          theme="dark"
          ...
          <div className="flex h-full items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden text-right md:block">
                <p className="m-0 text-xs uppercase tracking-wider text-slate-400">Signed in</p>
                <p className="m-0 text-sm font-medium text-slate-700">{session?.user.email ?? 'agent@demo.com'}</p>
              </div>
